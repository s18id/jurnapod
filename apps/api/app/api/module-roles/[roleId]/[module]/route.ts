...
export const GET = withAuth(
  async (request, _auth) => {
    try {
      ...
      const moduleRoles = await listModuleRoles({ roleId, module: moduleName });
      ...
      console.error("GET /api/module-roles/:roleId/:module failed", error);
...
export const PUT = withAuth(
  async (request, _auth) => {
    try {
      ...
      console.error("PUT /api/module-roles/:roleId/:module failed", error);
      return Response.json(INTERNAL_SERVER_ERROR_RESPONSE, { status: 500 });
    }
  },
