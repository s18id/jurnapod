...
import { getAssetLedger } from "../../../../../../src/lib/fixed-assets-lifecycle";
...
export const GET = withAuth(
  async (request, auth) => {
    try {
      ...
      console.error("GET /api/accounts/fixed-assets/:id/ledger failed", error);
      return errorResponse("INTERNAL_SERVER_ERROR", "Ledger request failed", 500);
    }
  },
