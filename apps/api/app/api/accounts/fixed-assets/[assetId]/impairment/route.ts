...
import { ImpairmentRequestSchema, NumericIdSchema } from "@jurnapod/shared";
import { ZodError } from "zod";
import { requireAccess, withAuth } from "../../../../../../src/lib/auth-guard";
import { errorResponse, successResponse } from "../../../../../../src/lib/response";
import { recordImpairment } from "../../../../../../src/lib/fixed-assets-lifecycle";
  ...
  async (request, auth) => {
    try {
      ...
      if (err.code === "INVALID_STATE") {
        return errorResponse("INVALID_REQUEST", err.message || "Asset must be acquired first", 400);
      }
      ...
      console.error("POST /api/accounts/fixed-assets/:id/impairment failed", error);
      return errorResponse("INTERNAL_SERVER_ERROR", "Impairment failed", 500);
    }
  },
