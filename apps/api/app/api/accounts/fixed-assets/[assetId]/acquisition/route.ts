...
import { AcquisitionRequestSchema, NumericIdSchema } from "@jurnapod/shared";
import { ZodError } from "zod";
import { requireAccess, withAuth } from "../../../../../../src/lib/auth-guard";
import { errorResponse, successResponse } from "../../../../../../src/lib/response";
import { recordAcquisition } from "../../../../../../src/lib/fixed-assets-lifecycle";
...
export const POST = withAuth(
  async (request, auth) => {
    try {
      ...
      console.error("POST /api/accounts/fixed-assets/:id/acquisition failed", error);
      return errorResponse("INTERNAL_SERVER_ERROR", "Acquisition failed", 500);
    }
  },
