...
/**
 * GET /api/accounts/types/:accountTypeId
...
export const GET = withAuth(
  async (request, auth) => {
    try {
      ...
      console.error("GET /api/accounts/types/:accountTypeId failed", error);
...
/**
 * PUT /api/accounts/types/:accountTypeId
...
export const PUT = withAuth(
  async (request, auth) => {
    try {
      ...
      console.error("PUT /api/accounts/types/:accountTypeId failed", error);
      return errorResponse("INTERNAL_ERROR", "Internal server error", 500);
    }
  },
...
/**
 * DELETE /api/accounts/types/:accountTypeId
...
export const DELETE = withAuth(
  async (request, auth) => {
    try {
      ...
      console.error("DELETE /api/accounts/types/:accountTypeId failed", error);
      return errorResponse("INTERNAL_ERROR", "Internal server error", 500);
    }
  },
