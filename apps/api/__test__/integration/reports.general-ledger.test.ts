...
test(
  "@slow reports integration: general-ledger account pagination returns lines with running balance",
  ...
  async () => {
    ...
    try {
      ...
      // Accounts referenced by journal_lines cannot be deleted either due to FK constraint
