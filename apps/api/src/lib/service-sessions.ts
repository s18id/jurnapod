...
// Error classes moved to lib/service-sessions/types.ts

// Types moved to lib/service-sessions/types.ts
...
// Re-export types and error classes from types module for backward compatibility
export type {
  ServiceSession,
  SessionLine,
  ListSessionsParams,
