...
| Epic 65 | Backoffice Frontend Foundation — Shell, Router, Auth, Typed API Client | planned (queued; requires backoffice unfreeze) | 65 |
| Epic 66 | Backoffice Core Admin — Users, Roles, Companies, Permissions UX | planned (queued; requires backoffice unfreeze) | 66 |
...
| Epic 70 | Backoffice Hardening — Accessibility, Internationalization, Testing, CI, Rollout | planned (queued; requires backoffice unfreeze) | 70 |
