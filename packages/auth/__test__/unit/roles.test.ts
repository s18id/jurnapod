...
import { checkRole, ROLE_CODES } from '../../src/rbac/roles.js';
import { hasPermissionBit, buildPermissionMask, MODULE_PERMISSION_BITS } from '../../src/rbac/permissions.js';
import type { RoleCode, ModulePermission } from '../../src/types.js';
