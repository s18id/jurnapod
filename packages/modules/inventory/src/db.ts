...
/**
 * Database configuration for inventory module.
 * 
 * Reads database configuration from environment variables.
 * This is used internally by the inventory services.
 */
...
/**
 * Get or create the singleton database instance for the inventory module.
 * Uses getKysely under the hood for caching.
 */
export function getInventoryDb(): KyselySchema {
