...
/**
 * ESLint Configuration for @jurnapod/modules-inventory
 *
 * Boundary rules enforce ADR-0014 package boundary policy:
 * 1. packages/** must never import from apps/**
 * 2. @jurnapod/modules-inventory must not import other domain packages directly
        ...
        paths: [
          {
            ...
            message:
              "[ADR-0014] @jurnapod/modules-inventory must not import @jurnapod/modules-accounting.",
          },
          {
            name: "@jurnapod/modules-sales",
            message:
              "[ADR-0014] @jurnapod/modules-inventory must not import @jurnapod/modules-sales.",
          },
          {
            name: "@jurnapod/modules-reservations",
            message:
              "[ADR-0014] @jurnapod/modules-inventory must not import @jurnapod/modules-reservations.",
          },
          {
            name: "@jurnapod/modules-reporting",
            message:
              "[ADR-0014] @jurnapod/modules-inventory must not import @jurnapod/modules-reporting.",
          },
          {
