...
/**
 * Service Sessions Module - Shared Utilities
 *
...
import {
  ...
  type ServiceSessionLineStateType,
...
export function mapDbRowToSessionLine(row: SessionLineDbRow): SessionLine {
  return {
    ...
    lineState: (row.line_state ?? ServiceSessionLineState.OPEN) as ServiceSessionLineStateType,
