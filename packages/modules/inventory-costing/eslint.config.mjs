...
/**
 * ESLint Configuration for @jurnapod/modules-inventory-costing
 *
        ...
        paths: [
          {
            ...
            message:
              "[ADR-0014] @jurnapod/modules-inventory-costing must not import @jurnapod/modules-accounting.",
          },
          {
            name: "@jurnapod/modules-sales",
            message:
              "[ADR-0014] @jurnapod/modules-inventory-costing must not import @jurnapod/modules-sales.",
          },
          {
