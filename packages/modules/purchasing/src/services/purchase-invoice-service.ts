...
export class PurchaseInvoiceService {
  ...
  async listPIs(params: PIListParams): Promise<PIListResult> {
    ...
    return {
      invoices: rows.rows.map((r) => ({
        ...
        invoice_date: toUtcIso.dateLike(r.invoice_date) as string,
        due_date: r.due_date ? toUtcIso.dateLike(r.due_date) as string : null,
  ...
  async getPIById(companyId: number, piId: number): Promise<PIGetResult | null> {
    ...
    return {
      ...
      invoice_date: toUtcIso.dateLike(h.invoice_date) as string,
      due_date: h.due_date ? toUtcIso.dateLike(h.due_date) as string : null,
