 ...
 */
export { PERMISSION_BITS, PERMISSION_MASK, ROLE_CODES, ROLE_PERMISSION_MATRIX, MODULE_ROLE_DEFAULTS, MODULE_ROLE_DEFAULTS_API, PERMISSION_MAP, } from "@jurnapod/shared";
