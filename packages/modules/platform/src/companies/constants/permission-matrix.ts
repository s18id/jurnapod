...
export const MODULE_ROLE_DEFAULTS = [
  ...
  { roleCode: "COMPANY_ADMIN", module: "accounting.accounts", permissionMask: PERMISSION_MASK.CRUDA },
  ...
  { roleCode: "COMPANY_ADMIN", module: "inventory.items", permissionMask: PERMISSION_MASK.CRUDA },
  { roleCode: "COMPANY_ADMIN", module: "inventory.stock", permissionMask: PERMISSION_MASK.CRUDA },
  ...
  { roleCode: "ADMIN", module: "accounting.accounts", permissionMask: PERMISSION_MASK.CRUDA },
  ...
  { roleCode: "ACCOUNTANT", module: "accounting.accounts", permissionMask: PERMISSION_MASK.CRUDA },
  ...
  { roleCode: "ACCOUNTANT", module: "inventory.items", permissionMask: 0 },
  { roleCode: "ACCOUNTANT", module: "inventory.stock", permissionMask: 0 },
