 ...
 */
export async function createTestOutletMinimal(db, companyId, options) {
 ...
 */
export async function createTestOutletWithoutTimezone(db, companyId, options) {
    const runId = makeRunId();
    const code = (options?.code ?? `TEST-OL-${runId}`).slice(0, 20).toUpperCase();
    const name = options?.name ?? `Test Outlet ${runId}`;
    try {
...
//# sourceMappingURL=outlet-fixtures.js.map