...
/**
 * ESLint Configuration for @jurnapod/modules-reporting
 *
 * Boundary rules enforce ADR-0014 package boundary policy:
 * 1. packages/** must never import from apps/**
 * 2. @jurnapod/modules-reporting must not import other domain packages directly
        ...
        paths: [
          {
            ...
            message:
              "[ADR-0014] @jurnapod/modules-reporting must not import @jurnapod/modules-accounting.",
          },
          {
            name: "@jurnapod/modules-sales",
            message:
              "[ADR-0014] @jurnapod/modules-reporting must not import @jurnapod/modules-sales.",
          },
          {
            name: "@jurnapod/modules-inventory",
            message:
              "[ADR-0014] @jurnapod/modules-reporting must not import @jurnapod/modules-inventory.",
          },
          {
            name: "@jurnapod/modules-reservations",
            message:
              "[ADR-0014] @jurnapod/modules-reporting must not import @jurnapod/modules-reservations.",
          },
          {
