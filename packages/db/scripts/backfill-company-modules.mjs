...
function resolveModuleCatalog() {
  return [
    ...
    { code: "treasury", name: "Treasury", description: "Cash and bank transaction management" },
    { code: "accounting", name: "Accounting", description: "General ledger, journals, accounts, fiscal years" },
    { code: "reservations", name: "Reservations", description: "Bookings and table management" },
...
function buildCompanyModules(flags) {
  ...
  return {
    ...
    treasury: { enabled: true, config: {} },
    accounting: { enabled: true, config: {} },
    reservations: { enabled: true, config: {} },
