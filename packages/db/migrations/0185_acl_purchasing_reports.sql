...
-- Migration: 0185_acl_purchasing_reports.sql
-- Story 46.8: ACL seed for purchasing.reports
...
SELECT DISTINCT mr.company_id, mr.role_id, 'purchasing', 'reports', 63
...
-- ADMIN gets CRUDA (31)
INSERT IGNORE INTO module_roles (company_id, role_id, module, resource, permission_mask)
SELECT DISTINCT mr.company_id, mr.role_id, 'purchasing', 'reports', 31
FROM module_roles mr
INNER JOIN roles r ON r.id = mr.role_id
WHERE mr.module = 'platform'
  AND mr.resource = 'outlets'
...
-- CASHIER gets 0
INSERT IGNORE INTO module_roles (company_id, role_id, module, resource, permission_mask)
SELECT DISTINCT mr.company_id, mr.role_id, 'purchasing', 'reports', 0
FROM module_roles mr
INNER JOIN roles r ON r.id = mr.role_id
WHERE mr.module = 'platform'
  AND mr.resource = 'outlets'
