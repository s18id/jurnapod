...
/**
 * ESLint Configuration for @jurnapod/notifications
 * 
 ...
 * 
 * ADR-0014 Rule 7: @jurnapod/notifications receives resolved configuration via injection;
 * module settings/platform remain the source of values.
 * 
        ...
        patterns: [
          {
            ...
            message:
              "[ADR-0014] packages/** must never import from apps/** (or API aliases/paths). Notifications should receive resolved config via injection.",
          },
        ],
        paths: [
          {
