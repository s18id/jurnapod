...
/**
 * Pagination utilities — pure functions (no DB dependency).
 *
 * DB-dependent `executePaginatedQuery` remains in `apps/api/src/lib/pagination.ts`
 * as a thin adapter over the shared pure functions.
 */
