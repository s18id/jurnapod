...
/**
 * Error codes for Supplier Statements
 */
export const SUPPLIER_STATEMENT_ERROR_CODES = {
  NOT_FOUND: "SUPPLIER_STATEMENT_NOT_FOUND",
  SUPPLIER_NOT_OWNED: "SUPPLIER_STATEMENT_SUPPLIER_NOT_OWNED",
  SUPPLIER_NOT_ACTIVE: "SUPPLIER_STATEMENT_SUPPLIER_NOT_ACTIVE",
