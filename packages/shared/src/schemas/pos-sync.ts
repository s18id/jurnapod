...
export const PosTransactionSchema = z.object({
  ...
  opened_at: UtcIsoSchema.optional(),
  closed_at: UtcIsoSchema.nullable().optional(),
  ...
  active_orders: z
    .array(
      z.object({
        ...
        opened_at: UtcIsoSchema,
        closed_at: UtcIsoSchema.nullable(),
