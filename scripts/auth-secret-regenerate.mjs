...
const ENV_KEY = "AUTH_JWT_ACCESS_SECRET";
const ENV_KEY_PATTERN = /^\s*(?:export\s+)?AUTH_JWT_ACCESS_SECRET\s*=/;
const AUTHORITATIVE_ENV_KEY_PATTERN = /^AUTH_JWT_ACCESS_SECRET=/;
